...
BEGIN
    ...
    -- Drop verification table policies  
    DROP POLICY IF EXISTS "Users can create verifications for their own skills" ON public.skill_video_verifications;
    DROP POLICY IF EXISTS "Users can view their own verifications" ON public.skill_video_verifications;
EXCEPTION
...
-- Create the skills video verification table if it doesn't exist
