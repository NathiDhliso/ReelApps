/*
  # Fix missing profiles and RLS policies

  1. Fix RLS policies to prevent infinite recursion
  2. Create profiles for existing users who don't have them
  3. Set up trigger to auto-create profiles for new users
*/
